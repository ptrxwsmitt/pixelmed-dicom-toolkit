...
public class DeidentifyAndRedact {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/apps/DeidentifyAndRedact.java,v 1.28 2022/01/21 19:51:11 dclunie Exp $";
	...
	protected class OurMediaImporter extends MediaImporter {
		 ...
		 * <p>Also performs {@link ClinicalTrialsAttributes#remapUIDAttributes(AttributeList) ClinicalTrialsAttributes.remapUIDAttributes(AttributeList)}</p>
		 *
...
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): "+dicomFileName);
			slf4jlogger.info("OurMediaImporter.doSomethingWithDicomFile(): Processing {} Transfer Syntax {}",dicomFileName,inputTransferSyntaxUID);
			try {
...
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): list.read()");
					list.read(i);
//long currentTime = System.currentTimeMillis();
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): reading AttributeList took = "+(currentTime-startTime)+" ms");
//startTime=currentTime;
					...
					if (aPixelData != null) {
						if (redactionRegions != null) {
							...
							slf4jlogger.debug("OurMediaImporter.doSomethingWithDicomFile(): redactionRegion selector classNameForThisImage = "+classNameForThisImage);
							...
							if (redactionShapes != null && redactionShapes.size() > 0) {
								...
								if (doitwithjpeg && (aPixelData instanceof OtherByteAttributeMultipleCompressedFrames || aPixelData instanceof OtherByteAttributeCompressedSeparateFramesOnDisk)) {
									...
									ImageEditUtilities.blackoutJPEGBlocks(list,redactionShapes);
								}
								else {
...
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): no redaction shapes specified");
							}
						}
						else {
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): no redaction regions specified");
						}
					}
					else {
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): not an image ... only de-identifying non-PixelData attributes");
					}
...
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): cleaning AttributeList took = "+(currentTime-startTime)+" ms");
//startTime=currentTime;
...
//currentTime = System.currentTimeMillis();
//System.err.println("OurMediaImporter.doSomethingWithDicomFile(): writing AttributeList took = "+(currentTime-startTime)+" ms");
//startTime=currentTime;
...
//System.err.println("rectangle = \""+rectangle+"\"");
	 ...
	 *
	 * <p>For details of the processing, see {@link OurMediaImporter#doSomethingWithDicomFileOnMedia(String,String,String)}.</p>
	 *
	 * <p>For specification of the contents of the redaction control file, see {@link RedactionRegions}.</p>
	 *
