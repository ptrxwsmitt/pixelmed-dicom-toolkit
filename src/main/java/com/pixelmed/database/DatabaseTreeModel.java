 ...
 * {@link TreeModel TreeModel} to abstract the contents of a database as
 * a tree in order to provide support for a {@link DatabaseTreeBrowser DatabaseTreeBrowser}.</p>
 *
