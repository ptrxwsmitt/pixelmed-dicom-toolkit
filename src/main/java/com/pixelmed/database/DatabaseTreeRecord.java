...
/**
 * <p>Instances of the {@link DatabaseTreeRecord DatabaseTreeRecord} class represent
 * nodes in a tree of the {@link DatabaseTreeModel DatabaseTreeModel} class, which in
 * turn is used by the {@link DatabaseTreeBrowser DatabaseTreeBrowser} class.</p>
 *
 * <p>This class is publically visible primarily so that selection change listeners can be
 * constructed for {@link DatabaseTreeBrowser DatabaseTreeBrowser}, since
 * the user's selection is returned as a path of {@link DatabaseTreeRecord DatabaseTreeRecord}
 * instances, which need to be cast accordingly.</p>
 *
 * @author	dclunie
 */
public class DatabaseTreeRecord implements Comparable, MutableTreeNode {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/DatabaseTreeRecord.java,v 1.33 2022/01/21 19:51:13 dclunie Exp $";
	 ...
	 * of strings (as described in the definition of {@link String#compareTo(String) java.lang.String.compareTo(String)}
	 * but rather accounts for embedded non-zero padded integers. See {@link StringUtilities#compareStringsWithEmbeddedNonZeroPaddedIntegers(String,String) com.pixelmed.utils.compareStringsWithEmbeddedNonZeroPaddedIntegers(String,String)}
	 * </p>
	 *
	 ...
	 *
	 * @param	o	the {@link DatabaseTreeRecord DatabaseTreeRecord}
	 *			to compare this {@link DatabaseTreeRecord DatabaseTreeRecord} against
...
//System.err.println("DatabaseTreeRecord.getChildCount() for "+this);
	...
	/**
	 * <p>Returns the children of this node as an {@link Enumeration Enumeration}.</p>
	 *
