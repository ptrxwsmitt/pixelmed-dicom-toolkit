...
/**
 * <p>The {@link MapTableBrowser MapTableBrowser} class extends a
 * {@link JTable JTable} to browse a list of attributes and their values
 * as a single row table with columns headed by the attribute descriptions (if
 * supplied) or their names.</p>
 *
 * <p>For details of some of the methods implemented here see {@link JTable javax.swing.JTable}.</p>
 *
 * @author	dclunie
 */
public class MapTableBrowser extends JTable {

	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/MapTableBrowser.java,v 1.12 2022/01/21 19:51:13 dclunie Exp $";
