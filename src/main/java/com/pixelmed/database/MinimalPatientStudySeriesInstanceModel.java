...
/**
 * <p>The {@link MinimalPatientStudySeriesInstanceModel MinimalPatientStudySeriesInstanceModel} class
 ...
 *
 * @see DicomDictionaryForMinimalPatientStudySeriesInstanceModel
 *
 * @author	dclunie
 */
public class MinimalPatientStudySeriesInstanceModel extends DicomDatabaseInformationModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/MinimalPatientStudySeriesInstanceModel.java,v 1.13 2022/01/21 19:51:13 dclunie Exp $";

	/**
	 * <p>Construct a model with the attributes from the default dictionary.</p>
	 *
	 * <p>The dictionary {@link DicomDictionaryForMinimalPatientStudySeriesInstanceModel DicomDictionaryForMinimalPatientStudySeriesInstanceModel} is used.</p>
	 * 
