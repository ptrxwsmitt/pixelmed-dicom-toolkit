...
/**
 * <p>The {@link StudySeriesInstanceSelectiveMatchModel StudySeriesInstanceSelectiveMatchModel} class
 ...
 * that level, not just the instance UIDs alone that are used in {@link StudySeriesInstanceModel StudySeriesInstanceModel}.</p>
 *
 * <p>Attributes of other DICOM entities than Study, Series and Instance are included at the appropriate lower level entity.</p>
 *
 * @see StudySeriesInstanceModel
 *
 * @author	dclunie
 */
