...
/**
 * <p>The {@link PatientStudySeriesConcatenationInstanceModel PatientStudySeriesConcatenationInstanceModel} class
 ...
 *
 * @see DicomDictionaryForPatientStudySeriesConcatenationInstanceModel
 *
 * @author	dclunie
 */
public class PatientStudySeriesConcatenationInstanceModel extends DicomDatabaseInformationModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/PatientStudySeriesConcatenationInstanceModel.java,v 1.32 2022/01/21 19:51:14 dclunie Exp $";

	/**
	 * <p>Construct a model with the attributes from the default dictionary.</p>
	 *
	 * <p>The dictionary {@link DicomDictionaryForPatientStudySeriesConcatenationInstanceModel DicomDictionaryForPatientStudySeriesConcatenationInstanceModel} is used.</p>
	 * 
...
//System.err.print(d);
			{
				...
				Iterator i = sopInstanceUIDs.iterator();
				while (i.hasNext()) {
			...
			{
				String localFileNameColumnName = d.getLocalFileNameColumnName(InformationEntity.INSTANCE);
				Iterator i = localFileNames.iterator();
				while (i.hasNext()) {
