...
/**
 * <p>The {@link DicomDictionaryBase DicomDictionaryBase} class
...
public abstract class DicomDictionaryBase {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DicomDictionaryBase.java,v 1.16 2022/01/21 19:51:15 dclunie Exp $";
...
//System.err.println("DicomDictionaryBase.getValueRepresentationFromTag: "+tag+" returns "+vr);
	...
	/**
	 * <p>Get an {@link Iterator Iterator} to iterate through every tag in the dictionary.</p>
	 *
	 * <p>The order in which the dictionary attributes are returned is by ascending tag value.</p>
	 *
	 * @see AttributeTag#compareTo(Object)
	 *
	 * @return		an iterator
	 */
