 ...
 *
 * <p>Implements {@link Comparable Comparable} in order to facilitate sorting (e.g. in lists
 ...
 * (i.e. it takes care to implement {@link Object#hashCode() hashCode()} and {@link Object#equals(Object) equals()} consistently).</p>
 * 
 * @author	dclunie
 */
public class AttributeTag implements Comparable {
	 ...
	 *
	 * @param	o	the {@link AttributeTag AttributeTag} to compare this {@link AttributeTag AttributeTag} against
...
//System.err.println("AttributeTag.equals: "+this+" vs. "+(AttributeTag)o+" = "+(group == ((AttributeTag)o).getGroup() && element == ((AttributeTag)o).getElement()));
	 ...
	 *
	 * <p>This method is implemented to override {@link Object#hashCode() java.lang.Object.hashCode()}
