...
public class DecimalStringAttribute extends StringAttribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DecimalStringAttribute.java,v 1.25 2022/01/21 19:51:15 dclunie Exp $";
	 ...
	 *
	 * @return	'D','S' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
