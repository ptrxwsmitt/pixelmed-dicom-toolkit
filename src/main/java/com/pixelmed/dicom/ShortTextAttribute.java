...
public class ShortTextAttribute extends TextAttribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/ShortTextAttribute.java,v 1.20 2022/01/21 19:51:18 dclunie Exp $";
	 ...
	 *
	 * @return	'S','T' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
