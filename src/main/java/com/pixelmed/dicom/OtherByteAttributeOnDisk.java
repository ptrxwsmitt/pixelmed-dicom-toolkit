...
public class OtherByteAttributeOnDisk extends OtherAttributeOnDisk {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/OtherByteAttributeOnDisk.java,v 1.19 2022/01/21 19:51:17 dclunie Exp $";
	 ...
	 * {@link AttributeFactory AttributeFactory} silently created an instance of this
	 * class rather than an in-memory {@link OtherByteAttribute OtherByteAttribute}.</p>
	 *
...
//System.err.println("OtherWordAttributeOnDisk.getByteValuesForSelectedFrame(): lazy read of selected frame "+frameNumber+" into heap allocated memory, rather than using memory mapped buffer :(");
	 ...
	 *
	 * @return	'O','B' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
