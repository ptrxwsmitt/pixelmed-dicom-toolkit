...
public class DicomFileUtilities {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DicomFileUtilities.java,v 1.14 2022/01/21 19:51:15 dclunie Exp $";
	 ...
	 *
	 * <p>Note that this method may return true but {@link DicomInputStream DicomInputStream} and {@link AttributeList AttributeList} may fail
