...
public class HierarchicalImageReference extends HierarchicalSOPInstanceReference {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/HierarchicalImageReference.java,v 1.10 2022/01/21 19:51:16 dclunie Exp $";
	 ...
	 * <p>Construct an instance of a reference to an image, with its hierarchy.</p>
	 *
	 * @param	instanceReference		an existing {@link HierarchicalSOPInstanceReference HierarchicalSOPInstanceReference} for this image
	 * @param	referencedFrameNumber	the Referenced Frame Number
	 */
