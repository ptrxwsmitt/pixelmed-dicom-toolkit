...
/**
 * <p>The {@link AttributeTreeBrowser AttributeTreeBrowser} class implements a Swing graphical user interface
 * to browse the contents of an {@link AttributeTree AttributeTree}.</p>
 *
...
public class AttributeTreeBrowser {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeTreeBrowser.java,v 1.21 2022/01/21 19:51:14 dclunie Exp $";
