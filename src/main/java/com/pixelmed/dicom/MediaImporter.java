...
public class MediaImporter {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/MediaImporter.java,v 1.26 2022/02/13 16:27:44 dclunie Exp $";
...
//System.err.println("Referenced files: "+allDicomFiles);
	...
	/**
	 * <p>A class that implements {@link Runnable Runnable} so that it can be invoked by {@link java.awt.EventQueue#invokeAndWait(Runnable) EventQueue.invokeAndWait()}.</p>
	 *
