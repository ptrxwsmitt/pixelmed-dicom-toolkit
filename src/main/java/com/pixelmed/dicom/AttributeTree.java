...
/**
 * <p>The {@link AttributeTree AttributeTree} class implements a
 * {@link TreeModel TreeModel} to abstract the contents of a list of attributes as
 * a tree in order to provide support for a {@link AttributeTreeBrowser AttributeTreeBrowser}.</p>
 *
 * <p>For details of some of the methods implemented here see {@link TreeModel javax.swing.tree.TreeModel}.</p>
 *
 * @see AttributeTreeBrowser
 * @see AttributeTreeRecord
 *
 * @author	dclunie
 */
public class AttributeTree implements TreeModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeTree.java,v 1.16 2022/01/21 19:51:14 dclunie Exp $";
	 ...
	 *
	 * <p>Attributes are added in the natural order of the {@link AttributeList AttributeList}.</p>
	 *
