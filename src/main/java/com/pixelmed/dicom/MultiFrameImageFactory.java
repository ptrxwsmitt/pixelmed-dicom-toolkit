 ...
 *
 * <p>Each enhanced image corresponds to one {@link FrameSet FrameSet}.</p>
 *
...
public class MultiFrameImageFactory {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/MultiFrameImageFactory.java,v 1.48 2022/01/21 19:51:16 dclunie Exp $";
...
//System.err.println("MultiFrameImageFactory.addPlaneOrientationFunctionalGroupDerivedFromAngle(): is unit vector");
	 ...
	 * otherwise in the worst case the {@link SOPClass#RawDataStorage SOPClass.RawDataStorage} is returned.</p>
	 *
	...
	/**
	 * <p>Create an enhanced image from a set of DICOM single image files or {@link AttributeList AttributeList}s in a FrameSet.</p>
	 *
	 ...
	 * @param	listsBySOPInstanceUID					an existing map of the SOP Instance UIDs of the single images to the {@link AttributeList AttributeList}s that contain them (null if filesBySOPInstanceUID supplied)
