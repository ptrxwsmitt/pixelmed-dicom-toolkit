...
public abstract class StoredFilePathStrategy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/StoredFilePathStrategy.java,v 1.11 2022/01/21 19:51:18 dclunie Exp $";
	 ...
	 *
	 * @see StoredFilePathStrategySingleFolder
	 */
	 ...
	 *
	 * @see StoredFilePathStrategyComponentFolders
	 */
	 ...
	 * of the SOP Instance UID as the folder name and the SOP Instance UID as the filename within the most deeply nested folder.</p>
	 *
	 * @see StoredFilePathStrategyHashSubFolders
	 */
