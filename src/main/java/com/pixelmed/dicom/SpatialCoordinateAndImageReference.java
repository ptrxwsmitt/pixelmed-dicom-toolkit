 ...
 *
 * @see StructuredReport#findAllContainedSOPInstances(ContentItem,ContentItem)
 *
 * @author	dclunie
 */
public class SpatialCoordinateAndImageReference {

	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/SpatialCoordinateAndImageReference.java,v 1.19 2022/01/21 19:51:18 dclunie Exp $";
	 ...
	 * @param	annotation			a {@link String String} value describing the reference (typically a parent Concept Name)
	...
	/**
	 * <p>Get rendering intent as {@link String String}.</p>
	 *
	 * @return	a {@link String String} describing the rendering intent
	 */
	...
	/**
	 * <p>Get category as {@link String String}.</p>
	 *
	 * @return	a {@link String String} describing the coordinate category
	 */
	...
	/**
	 * <p>Dump a human-readable representation as a {@link String String}.</p>
	 *
	 * @return		the annotation
	 */
