...
/**
 * <p>The {@link AttributeListTableModel AttributeListTableModel} class extends a
 * {@link AbstractTableModel AbstractTableModel} to abstract the contents of a list of attributes as
 * a single row table in order to provide support for a {@link AttributeListTableBrowser AttributeListTableBrowser}.</p>
 *
...
public class AttributeListTableModel extends AbstractTableModel {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeListTableModel.java,v 1.22 2022/01/21 19:51:14 dclunie Exp $";
