...
/**
 * <p>A class that extends {@link FilterOutputStream FilterOutputStream} by
...
public class AsynchronousOutputStream extends FilterOutputStream {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AsynchronousOutputStream.java,v 1.13 2022/01/21 19:51:14 dclunie Exp $";
...
//System.err.println("AsynchronousOutputStream.Consumer.consume(): isRequestToClose, setting done ");
	...
	/**
	 * @param	out	the {@link OutputStream OutputStream} to write to
	 */
