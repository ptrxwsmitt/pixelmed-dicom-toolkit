...
public abstract class ContentItem implements TreeNode {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/ContentItem.java,v 1.34 2022/01/21 19:51:15 dclunie Exp $";
...
//System.err.println("getIndexOfChild: found "+child);
	...
	/**
	 * <p>Construct a content item of a specified type and relationship, creating a new {@link AttributeList AttributeList}, and add it as a child of the specified parent.</p>
	 *
	 * <p>The constructor is protected. Instances of specific types of content items should normally be created by using
	 * the {@link ContentItemFactory ContentItemFactory}.</p>
	 *
...
//System.err.println("ContentItem.addChild(): child = "+child);
	 ...
	 *
	 * <p>This method saves the caller from having to cast the value returned from {@link TreeNode#getParent() TreeNode.getParent()}.</p>
	 *
