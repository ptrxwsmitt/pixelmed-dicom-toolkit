 ...
 * and writes messages to {@link System#err System.err}.</p>
 *
...
public class LoggerFactory {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/slf4j/LoggerFactory.java,v 1.8 2022/01/21 19:51:27 dclunie Exp $";
	...
	public static Logger getLogger(Class<?> clazz) {
		...
		if (logger == null) {
			logger = new Logger(clazz == null ? "" : clazz.getName());
		}
		return logger;
	}
}
