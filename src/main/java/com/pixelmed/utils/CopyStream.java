...
public class CopyStream {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/utils/CopyStream.java,v 1.21 2022/01/21 19:51:31 dclunie Exp $";
...
//System.err.println("CopyStream.skipInsistently(): asked for ="+remaining+" got="+bytesSkipped);
	 ...
	 * streams are used as is, and no {@link BufferedInputStream BufferedInputStream}
	 * or {@link BufferedOutputStream BufferedOutputStream} is inserted; the caller
