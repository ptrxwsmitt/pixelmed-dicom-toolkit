...
/**
 * <p>A class that implements {@link Runnable Runnable} so that it can be invoked by {@link java.awt.EventQueue#invokeLater(Runnable) EventQueue.invokeLater()}.</p>
 *
 ...
 *
 * <p>So, for example, instead of directly accessing the {@link JProgressBar JProgressBar} methods:</p>
 * <pre>
...
public class SafeProgressBarUpdaterThread implements Runnable {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/SafeProgressBarUpdaterThread.java,v 1.10 2022/01/21 19:51:20 dclunie Exp $";
