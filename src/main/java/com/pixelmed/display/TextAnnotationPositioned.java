...
public class TextAnnotationPositioned {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/TextAnnotationPositioned.java,v 1.15 2022/01/21 19:51:21 dclunie Exp $";
	...
	/**
	 * @deprecated See {@link DrawingUtilities#drawShadowedString(String,int,int,Graphics2D) DrawingUtilities.drawShadowedString()}
	 */
