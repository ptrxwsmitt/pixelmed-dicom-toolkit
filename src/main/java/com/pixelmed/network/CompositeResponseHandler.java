 ...
 *
 * @see ReceivedDataHandler
 * @see StorageSOPClassSCU
 * @see FindSOPClassSCU
 *
 * @author	dclunie
 */
abstract public class CompositeResponseHandler extends ReceivedDataHandler {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CompositeResponseHandler.java,v 1.27 2022/01/21 19:51:24 dclunie Exp $";
