 ...
 * {@link IdentifierHandler IdentifierHandler}. Any objects received are handled by the supplied
 * {@link ReceivedObjectHandler ReceivedObjectHandler}.</p>
 *
 ...
 * </pre>
 *
 * @see IdentifierHandler
 * @see ReceivedObjectHandler
 * @see PresentationContextListFactory
 *
 * @author	dclunie
 */
public class GetSOPClassSCU extends SOPClass {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/GetSOPClassSCU.java,v 1.31 2022/01/21 19:51:24 dclunie Exp $";
...
//totalLengthsOfAllFiles += lengthOfFile;
	 ...
	 * @param	affectedSOPClass		the SOP Class defining which query model, e.g. {@link SOPClass#StudyRootQueryRetrieveInformationModelGet SOPClass.StudyRootQueryRetrieveInformationModelGet}
