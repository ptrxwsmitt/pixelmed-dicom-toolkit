...
public class AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy implements PresentationContextSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy.java,v 1.11 2022/01/21 19:51:23 dclunie Exp $";
