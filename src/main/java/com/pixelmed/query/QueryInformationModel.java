 ...
 * {@link StudyRootQueryInformationModel StudyRootQueryInformationModel},
 ...
 * </ul>
 *
 * @see StudyRootQueryInformationModel
 *
 * @author	dclunie
 */
abstract public class QueryInformationModel {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/query/QueryInformationModel.java,v 1.35 2022/01/21 19:51:26 dclunie Exp $";
...
//System.err.println("makeIdentifierFromAttributesAtThisQueryLevel: adding "+a);
	...
	/**
	 * @deprecated	See {@link QueryInformationModel#performHierarchicalMoveFrom(AttributeList,String) performHierarchicalMoveFrom()}.
	 */
