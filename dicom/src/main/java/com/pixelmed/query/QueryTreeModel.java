...
/**
 * <p>The {@link QueryTreeModel QueryTreeModel} class implements a
 * {@link TreeModel TreeModel} to abstract the contents of a query response as
 * a tree in order to provide support for a {@link QueryTreeBrowser QueryTreeBrowser}.</p>
 *
 * @see TreeModel
 *
 * @author	dclunie
...
public class QueryTreeModel implements TreeModel {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/query/QueryTreeModel.java,v 1.18 2022/01/21 19:51:26 dclunie Exp $";
