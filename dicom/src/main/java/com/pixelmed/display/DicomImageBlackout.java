...
public class DicomImageBlackout extends JFrame  {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/DicomImageBlackout.java,v 1.66 2022/01/21 19:51:19 dclunie Exp $";
...
//System.err.println("DicomImageBlackout.OurFrameSelectionChangeListener.changed(): event="+fse);
	...
	/**
	 *<p>A class of values for the Burned in Annotation action argument of the {@link DicomImageBlackout#DicomImageBlackout(String,String [],StatusNotificationHandler,int) DicomImageBlackout()} constructor.</p>
	 */
	 ...
	 * supplied as an argument of the {@link DicomImageBlackout#DicomImageBlackout(String,String [],StatusNotificationHandler,int) DicomImageBlackout()} constructor.</p>
	 */
