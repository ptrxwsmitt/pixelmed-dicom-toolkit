...
public class CapabilitiesAvailable {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/utils/CapabilitiesAvailable.java,v 1.18 2022/03/08 12:48:06 dclunie Exp $";
	...
	public static void dumpListOfAllAvailableWriters(PrintStream out) {
		String[] formats=ImageIO.getWriterFormatNames();
		for (int i=0; formats != null && i<formats.length; ++i) {
			out.println(formats[i]+":");
			Iterator<ImageWriter> writers = ImageIO.getImageWritersByFormatName(formats[i]);
