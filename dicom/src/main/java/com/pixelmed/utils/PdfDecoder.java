...
public class PdfDecoder {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/utils/PdfDecoder.java,v 1.10 2022/01/21 19:51:32 dclunie Exp $";
	...
	public void setPageParameters(float scaling, int pageNumber) throws PdfException {
		try {
			Class [] argTypes  = { Float.TYPE, Integer.TYPE };
