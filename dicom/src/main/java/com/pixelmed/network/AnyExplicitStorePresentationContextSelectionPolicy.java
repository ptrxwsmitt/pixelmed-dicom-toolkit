...
public class AnyExplicitStorePresentationContextSelectionPolicy implements PresentationContextSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/AnyExplicitStorePresentationContextSelectionPolicy.java,v 1.11 2022/01/21 19:51:23 dclunie Exp $";
