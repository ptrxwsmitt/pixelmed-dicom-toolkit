...
public class CompositeInstanceStoreAbstractSyntaxSelectionPolicy implements AbstractSyntaxSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CompositeInstanceStoreAbstractSyntaxSelectionPolicy.java,v 1.10 2022/01/21 19:51:24 dclunie Exp $";
