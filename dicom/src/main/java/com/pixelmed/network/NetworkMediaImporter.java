...
public class NetworkMediaImporter extends MediaImporter {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/NetworkMediaImporter.java,v 1.12 2022/01/21 19:51:25 dclunie Exp $";
