 ...
 * {@link IdentifierHandler IdentifierHandler}.</p>
 *
...
public class FindSOPClassSCU extends SOPClass {
	 ...
	 * @param	affectedSOPClass	the SOP Class defining which query model, e.g. {@link SOPClass#StudyRootQueryRetrieveInformationModelFind SOPClass.StudyRootQueryRetrieveInformationModelFind}
