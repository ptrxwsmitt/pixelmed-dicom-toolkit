...
public class NetworkConfigurationFromMulticastDNS extends NetworkConfigurationSource {
	...
	public void activateDiscovery(int refreshInterval) {
		...
		try {
			...
			Class [] argTypes  = {};
			Method methodToUse = classToUse.getDeclaredMethod("create",argTypes);		// (000611)
			Object[] argValues = {};
	...
	public void registerDicomService(String calledApplicationEntityTitle,int port,String primaryDeviceType) {
		...
		if (jmDNS != null) {
			...
			try {
				...
				Class [] argTypes  = {String.class,String.class, Integer.TYPE, Integer.TYPE, Integer.TYPE,Map.class};
				// (000611)
				Method methodToUse = classToUse.getDeclaredMethod("create",argTypes);
