...
public class TestSendingCommandAndDataInOnePDU extends StorageSOPClassSCU {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/TestSendingCommandAndDataInOnePDU.java,v 1.14 2022/01/21 19:51:26 dclunie Exp $";
