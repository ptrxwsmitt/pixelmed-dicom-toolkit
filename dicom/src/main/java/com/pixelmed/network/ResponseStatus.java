...
public class ResponseStatus {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/ResponseStatus.java,v 1.9 2022/01/21 19:51:25 dclunie Exp $";
