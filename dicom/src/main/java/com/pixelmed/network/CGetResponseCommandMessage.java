...
public class CGetResponseCommandMessage implements CommandMessage {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CGetResponseCommandMessage.java,v 1.12 2022/01/21 19:51:24 dclunie Exp $";
