 ...
 *
 * <p>Used as a base class for {@link OtherByteAttributeOnDisk OtherByteAttributeOnDisk} and {@link OtherWordAttributeOnDisk OtherWordAttributeOnDisk}.</p>
 *
 * @see Attribute
 * @see AttributeFactory
 * @see AttributeList
 * @see OtherByteAttributeOnDisk
 * @see OtherWordAttributeOnDisk
 *
 * @author	dclunie
 */
public abstract class OtherAttributeOnDisk extends Attribute {

	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/OtherAttributeOnDisk.java,v 1.13 2022/01/21 19:51:17 dclunie Exp $";
	...
	/**
	 * <p>Read an attribute from a file.</p>
	 *
	 * @param	t			the tag of the attribute
	...
	public OtherAttributeOnDisk(AttributeTag t,File file,boolean deleteFilesWhenNoLongerNeeded) throws IOException, DicomException {
		...
		this.deleteFilesWhenNoLongerNeeded=deleteFilesWhenNoLongerNeeded;
	}
