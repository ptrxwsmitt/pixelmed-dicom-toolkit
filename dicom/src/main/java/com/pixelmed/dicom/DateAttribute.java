...
public class DateAttribute extends StringAttribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DateAttribute.java,v 1.21 2022/01/21 19:51:15 dclunie Exp $";
	 ...
	 *
	 * @return	'D','A' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
