 ...
 *
 * <p>There is no constructor or factory method, since one or more {@link FrameSet FrameSet}s is created by using {@link SetOfFrameSets SetOfFrameSets}.</p>
 *
 ...
 * {@link FrameSet FrameSet}s may span Series.</p>
 *
 * @author	dclunie
 */
...
//System.err.println("FrameSet.equalsAllowingForFloatingPointJitter(): different sizes");
	...
	/**
	 * <p>Extract the attributes and values that are required to be common to all members of this {@link FrameSet FrameSet}s
	 * and for which different values will create distinct {@link FrameSet FrameSet}s.</p>
	 *
	 * @param	list	a list of DICOM attributes
	 * @return			a list of the attributes with values required to be the same for membership in this {@link FrameSet FrameSet}s
	 */
	...
	/**
	 * <p>Extract the attributes and values that are potentially different for all members of this {@link FrameSet FrameSet}s.</p>
	 *
	 * @param	list	a list of DICOM attributes
	 * @return			a list of the attributes with values that are potentially different for each member of this {@link FrameSet FrameSet}s
	 */
...
//System.err.println("FrameSet.removeSharedAttributesThatAreNotInEveryFrame(): removing "+tag+" since only present in "+count+" frames");
	...
	/**
	 * <p>Partition the {@link FrameSet FrameSet}s into shared and per-frame attributes, if not already done.</p>
	 *
	...
	/**
	 * <p>Check to see if a single frame object is a potential member of the current {@link FrameSet FrameSet}s.</p>
	 *
	 * @param	list	a list of DICOM attributes for the object to be checked
	 * @return			true if the attribute list matches the criteria for membership in this {@link FrameSet FrameSet}s
	 */
...
//System.err.println("FrameSet.eligible(): "+isEligible);
	...
	/**
	 * <p>Insert the single frame object into the current {@link FrameSet FrameSet}s.</p>
	 *
	...
	/**
	 * <p>Create a new {@link FrameSet FrameSet} using the single frame object.</p>
	 *
	 * @param		list			a list of DICOM attributes for the object from which the {@link FrameSet FrameSet} is to be created
	 * @throws	DicomException	if no SOP Instance UID
	 */
	 ...
	 *
	 * @param	list	a list of DICOM attributes
	 * @return			a new {@link Set Set} of {@link AttributeTag AttributeTag}s
	 */
	...
	/**
	 * <p>Get the distinguishing AttributeTags used in this {@link FrameSet FrameSet} that are present with values.</p>
	 *
	...
	/**
	 * <p>Get the shared AttributeTags used in this {@link FrameSet FrameSet} that are present with values.</p>
	 *
	...
	/**
	 * <p>Get the per-frame varying AttributeTags used in this {@link FrameSet FrameSet} that are present with values.</p>
	 *
	...
	/**
	 * <p>Get the number of frames in this {@link FrameSet FrameSet}.</p>
	 *
	 * @return	the number of frames in this {@link FrameSet FrameSet}
	 */
	public int size() {
		partitionPerFrameIntoSharedAttributes();
