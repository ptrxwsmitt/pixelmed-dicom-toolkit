 ...
 * </pre>
 *
 * <p>Static methods are also provided for operating directly on an {@link AttributeList AttributeList}.</p>
 *
 * @author	dclunie
 */
public class CompositeInstanceContext {
	...
	/**
	 * <p>Return the {@link AttributeList AttributeList} of all the {@link Attribute Attribute}s in the context.</p>
	 *
	 * @return		the {@link AttributeList AttributeList} of all the {@link Attribute Attribute}s in the context
	 */
	...
	/**
	 * <p>Create the composite context module {@link Attribute Attribute}s with values from the supplied {@link AttributeList AttributeList}.</p>
	 *
	 * @param	forSR		true if need to populate the SR Document General Module specific {@link Attribute Attribute}s from their image equivalents
	 ...
	 * <p>Create the composite context module {@link Attribute Attribute}s with values from the supplied {@link AttributeList AttributeList}.</p>
	 *
	 * <p>Also populates the SR Document General Module specific {@link Attribute Attribute}s from their image equivalents.</p>
	 *
	 * @deprecated use  {@link CompositeInstanceContext#CompositeInstanceContext(AttributeList,boolean) CompositeInstanceContext(AttributeList,boolean)} instead
	 *
	 * @param	srcList		the list of attributes to use as the source
	 */
...
//System.err.println("CompositeInstanceContext.createPerformedProcedureCodeSequenceIfAbsent(): copying ProcedureCodeSequence to PerformedProcedureCodeSequence item "+item);
	...
	/**
	 * <p>Add or replace all of the composite context module {@link Attribute Attribute}s with values from the supplied {@link AttributeList AttributeList}.</p>
	 *
	 * <p>If an {@link Attribute Attribute} is empty or missing in the supplied list, the existing value in the context is left unchanged (not removed or emptied).</p>
	 *
	 * <p>This is useful when building composite context from multiple input composite instances, in which optional {@link Attribute Attribute}s are filled in some,
	 ...
	 * <p>Also populates the SR Document General Module specific {@link Attribute Attribute}s from their image equivalents.</p>
	 *
	 * @deprecated use  {@link CompositeInstanceContext#updateFromSource(AttributeList,boolean) updateFromSource(AttributeList,boolean)} instead
	 *
	 * @param	srcList		the list of attributes to use as the source
	 */
	...
	/**
	 * <p>Remove the Patient and Clinical Trial Subject modules {@link Attribute Attribute}s.</p>
	 *
	...
	/**
	 * <p>Remove the study, series, equipment, frame of reference and instance level modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the patient, series, equipment, frame of reference and instance level modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the patient, study, equipment, frame of reference and instance level modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the series, equipment, frame of reference and instance level modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the General Study, Patient Study and Clinical Trial Study modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the General Series and Clinical Trial Series modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the General Equipment module {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the Frame of Reference module {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the SOP Common and General Image module {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	/**
	 * <p>Remove the SR Document General Image module {@link Attribute Attribute}s.</p>
	 *
	 * @param	list	the list of attributes to edit
	 */
	...
	*/
	...
	/**
	 * <p>Remove the unselected modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list		the list of attributes to edit
	...
	/**
	 * <p>Remove the selected modules {@link Attribute Attribute}s.</p>
	 *
	 * @param	list		the list of attributes to edit
