...
public class LongTextAttribute extends TextAttribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/LongTextAttribute.java,v 1.20 2022/01/21 19:51:16 dclunie Exp $";
	 ...
	 *
	 * @return	'L','T' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
