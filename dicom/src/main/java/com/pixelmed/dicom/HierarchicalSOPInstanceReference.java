...
public class HierarchicalSOPInstanceReference {
	 ...
	 * @return		a {@link Map Map} of {@link String String} SOPInstanceUIDs to {@link HierarchicalSOPInstanceReference HierarchicalSOPInstanceReference}
	 */
	 ...
	 *
	 * @param	list									the top level dataset of an instance
	 * @param	hierarchicalInstancesBySOPInstanceUID	a {@link Map Map} of {@link String String} SOPInstanceUIDs to {@link HierarchicalSOPInstanceReference HierarchicalSOPInstanceReference} that is added to as references are found
	 */
