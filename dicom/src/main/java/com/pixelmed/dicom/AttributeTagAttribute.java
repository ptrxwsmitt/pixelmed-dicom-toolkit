...
public class AttributeTagAttribute extends Attribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeTagAttribute.java,v 1.24 2022/01/21 19:51:14 dclunie Exp $";
	...
	/**
	 * @param	s	a String of the form returned by {@link AttributeTag#toString() toString()}, i.e., "(0xgggg,0xeeee)" where gggg and eeee are the zero-padded hexadecimal representations of the group and element respectively
	 ...
	 *
	 * @return	'A','T' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
