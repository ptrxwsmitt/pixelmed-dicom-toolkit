...
public class DateTimeAttribute extends StringAttribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DateTimeAttribute.java,v 1.28 2022/01/21 19:51:15 dclunie Exp $";
	 ...
	 *
	 * @return	'D','T' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
	...
	/**
	 * <p>Get a DICOM format DT {@link String String} value from a Java {@link java.util.Date Date}.</p>
	 *
	 * <p>Will format the Date for the specified timezone.</p>
	 *
	 * @param	date				the Java {@link java.util.Date Date} to format
	 * @param	timezone			the Java {@link TimeZone TimeZone} to use
	 ...
	 * <p>Will format the Date for the default timezone, converting from whatever timezone is specified in the supplied {@link java.util.Date Date} if not the default.</p>
	 *
	 * @deprecated	use {@link DateTimeAttribute#getFormattedStringDefaultTimeZone(java.util.Date) getFormattedStringDefaultTimeZone()} instead
	 *
	 * @param	date			the Java {@link java.util.Date Date} to format
	 * @return					a DICOM formatted DT value
	 */
	...
	/**
	 * <p>Get a Java {@link java.util.Date Date} from a DICOM format DT {@link String String} value.</p>
	 *
...
//System.err.println("DateTimeAttribute.getDateFromFormattedString(): given "+dateString+" return "+date.toGMTString());
	...
	/**
	 * <p>Get a Java {@link TimeZone TimeZone} from a DICOM format {@link String String} time zone.</p>
	 *
	 ...
	 *
	 * @param		dicomTimeZone	the {@link String String} DICOM format time zone
	 * @return						a Java {@link TimeZone TimeZone} representing the supplied time zone, or the GMT zone if it cannot be understood
	 */
...
//System.err.println("DateTimeAttribute.getTimeZone(): useTimeZone = "+useTimeZone);
	...
	/**
	 * <p>Get a DICOM format {@link String String} time zone from a Java {@link TimeZone TimeZone} on a particular Java {@link java.util.Date Date} .</p>
	 *
	 * <p>E.g. from +0500 or -0700, the last component of a DateTime attribute value, or the value of the DICOM attribute TimezoneOffsetFromUTC. </p>
	 *
	 * @param		javaTimeZone	the {@link TimeZone TimeZone} time zone
	 * @param		javaDate		the {@link java.util.Date Date} used to establish whether daylight savings is in effect or not
	 * @return						a DICOM format {@link String String} time zone representing the supplied time zone on the supplied date
	 */
	public static String getTimeZone(TimeZone javaTimeZone, java.util.Date javaDate) {
...
//System.err.println("DateTimeAttribute.getTimeZone(): tzInDICOMFormat = "+tzInDICOMFormat);
	...
	/**
	 * <p>Get a DICOM format {@link String String} time zone representation of the current timezone.</p>
	 *
	 * <p>E.g. from +0500 or -0700, the last component of a DateTime attribute value, or the value of the DICOM attribute TimezoneOffsetFromUTC. </p>
	 *
	 * @return						a DICOM format {@link String String} time zone representing the current time zone on the current date
	 */
	public static String getCurrentTimeZone() {
		return getTimeZone(TimeZone.getDefault(),new java.util.Date());
	}
