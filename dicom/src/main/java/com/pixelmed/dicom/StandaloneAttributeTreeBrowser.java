...
/**
 * <p>The {@link StandaloneAttributeTreeBrowser StandaloneAttributeTreeBrowser} class implements a Swing graphical user interface
 * to browse the contents of an {@link AttributeTree AttributeTree} using an {@link AttributeTreeBrowser AttributeTreeBrowser}.</p>
 *
 * @see	AttributeTree
 *
 * @author	dclunie
