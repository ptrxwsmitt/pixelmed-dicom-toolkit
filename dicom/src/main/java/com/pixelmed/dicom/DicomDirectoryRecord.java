...
public abstract class DicomDirectoryRecord implements Comparable, TreeNode {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/DicomDirectoryRecord.java,v 1.28 2022/01/21 19:51:15 dclunie Exp $";
...
//System.err.println("DicomDirectoryRecord.equals(): comparing classes "+this.getClass()+" with "+o.getClass()+" with result "+areEqual);
	...
	/**
	 * <p>Make the value that will be retured on a call to {@link DicomDirectoryRecord#getStringValue() getStringValue()}.</p>
	 */
	abstract protected void makeStringValue();

	/**
	 * <p>Make the value that will be retured on a call to {@link DicomDirectoryRecord#getIntegerValue() getIntegerValue()}.</p>
	 */
	abstract protected void makeIntegerValue();

	/**
	 * @return	a {@link String String} describing this directory record containing identifiers, dates, etc.
	 */
