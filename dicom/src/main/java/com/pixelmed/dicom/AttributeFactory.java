...
/**
 * <p>The {@link AttributeFactory AttributeFactory} class is a factory class of static methods for creating
 * concrete instances of the abstract class {@link Attribute Attribute} based on their
...
public class AttributeFactory {
	...
	/**
	 * <p>A static method to determine the {@link Class Class} appropriate for storing an attribute based on the supplied value representation.</p>
	 *
	 * @param	tag								the {@link AttributeTag AttributeTag} tag of the attribute (to check whether or not pixel data)
...
//}
	...
	/**
	 * <p>A static method to create an {@link Attribute Attribute} based on the value representation from the standard dictionary.</p>
	 *
	 ...
	 *
	 * @param	tag			the {@link AttributeTag AttributeTag} tag of the attribute to create
	 *
	...
	/**
	 * <p>A static method to create an {@link Attribute Attribute} based on the supplied value representation.</p>
	 *
...
//System.err.println("made an "+a);
	...
	/**
	 * <p>A static method to create and read an {@link Attribute Attribute} from a {@link DicomInputStream DicomInputStream}.</p>
	 *
	 * <p>The stream is left positioned at the start of the next attribute.</p>
	 *
	 * @param	tag								the {@link AttributeTag AttributeTag} tag of the attribute to create (already read from the stream)
	 ...
	 * @param	i								the {@link DicomInputStream DicomInputStream} to read the attribute from, positioned at the start of the value(s) to read
	 * @param	specificCharacterSet			the {@link SpecificCharacterSet SpecificCharacterSet} to be used text values
	 * @param	explicit						a flag indicating that the stream is explicit value representation (affects pixel data encoding choice)
	 * @param	bytesPerSample					1 or 2 bytes per sample indicating whether to use OB or OW for pixel data
	 * @param	byteOffset						the byte offset from the beginning of the {@link DicomInputStream DicomInputStream}
	 * @param	isSignedPixelRepresentation		the PixelRepresentation is signed (needed to choose VR for US/SS VR data elements)
	 *
