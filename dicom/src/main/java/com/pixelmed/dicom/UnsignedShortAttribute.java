...
public class UnsignedShortAttribute extends Attribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/UnsignedShortAttribute.java,v 1.28 2022/01/21 19:51:19 dclunie Exp $";
	 ...
	 *
	 * @return	'U','S' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
