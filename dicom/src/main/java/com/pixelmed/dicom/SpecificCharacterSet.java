 ...
 * Unicode representation contained in {@link String String}.
 *
 * @author	dclunie
 */
public class SpecificCharacterSet {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/SpecificCharacterSet.java,v 1.42 2022/01/21 19:51:18 dclunie Exp $";
	...
	/**
	 * <p>Get an encoding capable of handling characters from the specified set of {@link Character.UnicodeBlock Character.UnicodeBlock}ss.</p>
	 *
	 * @param	setOfUnicodeBlocks		the set of {@link Character.UnicodeBlock Character.UnicodeBlock}s that need to be encodable
	...
	/**
	 * <p>Get the set of {@link Character.UnicodeBlock Character.UnicodeBlock}s used in a string.</p>
	 *
	 * @param	value	the string
	 * @return			a {@link Set Set} of {@link Character.UnicodeBlock Character.UnicodeBlock}s
	 *
	 */
	...
	/**
	 * <p>Get the set of {@link Character.UnicodeBlock Character.UnicodeBlock}s used in all of the values of the string attributes of a dataset.</p>
	 *
	 ...
	 * specified Specific Character Set, into a {@link String String}.
	 *
	...
	/**
	 * <p>Translate a byte array (such as a value from a DICOM attribute), using the
	 * specified encoding, into a {@link String String}.
	 *
	 * @param	bytes		the bytes to translate
	 * @param	offset		the offset into the byte array to start translation
	 * @param	length		how many bytes to translate
