...
/**
 * <p>A class with methods for constructing a {@link ContentItem ContentItem} of the appropriate class from a list of attributes.</p>
 *
 * <p>The sub-classes of {@link ContentItem ContentItem} are public internal classes of this class,
 ...
 *
 * @see ContentItem
 * @see ContentItemWithReference
 * @see ContentItemWithValue
...
public class ContentItemFactory {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/ContentItemFactory.java,v 1.50 2022/01/21 19:51:15 dclunie Exp $";
...
//System.err.println("ContentItemFactort.ContainerContentItem(): adding ContentTemplateSequence");
				...
				if (templateMappingResource != null) {
					Attribute a = new CodeStringAttribute(TagFromName.MappingResource); a.addValue(templateMappingResource.toUpperCase(Locale.US)); contentTemplateSequenceItemAttributeList.put(a);
				}
				if (templateIdentifier != null) {
					Attribute a = new CodeStringAttribute(TagFromName.TemplateIdentifier); a.addValue(templateIdentifier.toUpperCase(Locale.US)); contentTemplateSequenceItemAttributeList.put(a);
				}
...
//System.err.println("NumericContentItem.doCommonConstructorStuff(): SR pattern with MeasuredValueSequence");
	...
	public static boolean codeContentItemValueMatchesCodeValueAndCodingSchemeDesignator(ContentItem ci,String cvWanted,String csdWanted) {
		boolean isMatch = false;
		if (ci != null && ci instanceof CodeContentItem) {
			CodeContentItem cci = ( CodeContentItem)ci;
