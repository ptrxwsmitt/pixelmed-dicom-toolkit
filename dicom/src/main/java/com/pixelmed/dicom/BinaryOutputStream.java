...
public class BinaryOutputStream extends FilterOutputStream {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/BinaryOutputStream.java,v 1.24 2022/01/21 19:51:14 dclunie Exp $";
