...
public class SequenceAttribute extends Attribute {
	...
	/**
	 * Get an {@link Iterator Iterator} of the items in the sequence.
	 *
	 * @return	a {@link Iterator Iterator} of items, each encoded as an {@link SequenceItem SequenceItem}
	 */
	 ...
	 * @return		a {@link SequenceItem SequenceItem}, null if no items or no such item
	 */
	 ...
	 *
	 * @return	'S','Q' in ASCII as a two byte array; see {@link ValueRepresentation ValueRepresentation}
	 */
