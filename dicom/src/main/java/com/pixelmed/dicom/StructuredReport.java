...
/**
 * <p>The {@link StructuredReport StructuredReport} class implements a
 * {@link TreeModel TreeModel} to abstract the contents of a list of attributes
 * representing a DICOM Structured Report as
 * a tree in order to provide support for a {@link StructuredReportBrowser StructuredReportBrowser}.</p>
 *
 * <p>For details of some of the methods implemented here see {@link TreeModel javax.swing.tree.TreeModel}.</p>
 *
 ...
 *
 * @see ContentItem
 * @see ContentItemFactory
 * @see StructuredReportBrowser
 *
 * @author	dclunie
 */
public class StructuredReport implements TreeModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/StructuredReport.java,v 1.29 2022/01/21 19:51:18 dclunie Exp $";
...
//System.err.println(list.toString());
	...
	/**
	 * <p>Return the entire content tree of a structured report as an {@link AttributeList AttributeList}.</p>
	 *
	 * <p>Has the side effect of creating (or replacing) the ContentSequence attributes of the {@link AttributeList AttributeList} of each {@link ContentItem ContentItem} to represent the tree structure.</p>
	 *
	 * @return	a {@link AttributeList AttributeList} representing the content tree, or null if empty root.
	 */
	...
	/**
	 * <p>Dump the tree starting at the specified node as a {@link String String}.</p>
	 *
	 * @param	node
	 * @param	location	the dotted numeric string describing the location of the starting node
	 * @return	a multi-line {@link String String} representing the tree fragment
	 */
	...
	/**
	 * <p>Dump the entire tree as a {@link String String}.</p>
	 *
	 * @return	a multi-line {@link String String} representing the tree
	 */
	 ...
	 * @return		a {@link Vector Vector} of {@link SpatialCoordinateAndImageReference SpatialCoordinateAndImageReference}
	 */
