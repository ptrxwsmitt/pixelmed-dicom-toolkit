 ...
 * a minimal GET method for a web server, primarily as a basis to implement {@link WadoServer WadoServer}.</p>
 *
 * <p>An abstract inner class, such as {@link Worker HttpServer.Worker},
...
public abstract class HttpServer implements Runnable {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/web/HttpServer.java,v 1.17 2022/01/21 19:51:32 dclunie Exp $";
