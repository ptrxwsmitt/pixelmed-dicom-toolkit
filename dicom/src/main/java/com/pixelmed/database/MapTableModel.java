...
/**
 * <p>The {@link MapTableModel MapTableModel} class extends a
 * {@link AbstractTableModel AbstractTableModel} to abstract the contents of a database as
 * a tree in order to provide support for a {@link MapTableBrowser MapTableBrowser}.</p>
 *
...
public class MapTableModel extends AbstractTableModel {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/MapTableModel.java,v 1.16 2022/01/21 19:51:13 dclunie Exp $";
...
//System.err.println("MapTableModel.isAcceptable(): checking "+name+" is in exclude list "+excludeList.contains(name.toUpperCase(java.util.Locale.US)));
		return name != null && (excludeList == null || !excludeList.contains(name.toUpperCase(Locale.US)));
	}
