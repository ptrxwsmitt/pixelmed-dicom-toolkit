 ...
 *
 * <p>Abstract sub-classes, such as {@link DicomDatabaseInformationModel DicomDatabaseInformationModel},
 ...
 * representation (the database tables), usually by means of a specialized sub-class of {@link DicomDictionary DicomDictionary}
 * which contains the sub-set of relevant attributes and may change their mapping to information entities, such as
 * {@link DicomDictionaryForPatientStudySeriesConcatenationInstanceModel DicomDictionaryForPatientStudySeriesConcatenationInstanceModel}.</p>
 *
 * <p>For example, an application might instantiate a {@link PatientStudySeriesConcatenationInstanceModel PatientStudySeriesConcatenationInstanceModel}
 * or a {@link StudySeriesInstanceModel StudySeriesInstanceModel}, as follows:</p>
 *
 * <pre>
 *	final DatabaseInformationModel d = new PatientStudySeriesConcatenationInstanceModel("test");
 * </pre>
 *
 * <p>Composite objects previously read into a {@link AttributeList AttributeList} from a
...
public abstract class DatabaseInformationModel {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/DatabaseInformationModel.java,v 1.85 2022/01/21 19:51:13 dclunie Exp $";
	 ...
	 *
	 * @return	the {@link InformationEntity InformationEntity} at the top of the information model
	 */
	 ...
	 *
	 * @return	a {@link HashMap HashMap} indexed by {@link String String} upper case column names and containing {@link String String} descriptive names
	 */
	 ...
	 * @return			a {@link String String} column name, or null if not known
	 */
	 ...
	 * @return				the upper case {@link String String} column name, or null if not known
	 */
	public static String getDatabaseColumnNameFromDicomName(String descriptiveName) {
		String columnName = null;
		if (descriptiveName != null) {
			columnName = descriptiveName.toUpperCase(Locale.US);
		}
		return columnName;
	}
	 ...
	 * @return				a {@link String String} descriptive name of the DICOM element, or null if not known
	 */
	 ...
	 * {@link PatientStudySeriesConcatenationInstanceModel PatientStudySeriesConcatenationInstanceModel}
	 * for example.</p>
	 *
	 * @param	b		the statement being constructed
	 * @param	ie		the {@link InformationEntity InformationEntity} for which a create table statement is being constructed
	 */
	...
	/**
	 * @deprecated use  {@link DatabaseInformationModel#deleteRecord(InformationEntity,String) deleteRecord(InformationEntity,String)} instead
	 */
	 ...
	 *
	 * @param	ie						the {@link InformationEntity InformationEntity} that corresponds to the table containing the record to be deleted
	 ...
	 *
	 * <p>The information is taken from the supplied {@link AttributeList AttributeList},
	 ...
	 *
	 * @deprecated use  {@link DatabaseInformationModel#insertObject(AttributeList,String,String) insertObject()} instead
	 *
	 ...
	 * @param	b		the statement being constructed
	 * @param	list		the DICOM attributes of a composite object, containing the attributes describing this instance of the entity
	 * @param	ie		the {@link InformationEntity InformationEntity} for which a select statement is being constructed
	 * @throws	DicomException	thrown if there are problems extracting the DICOM attributes
	 */
	 ...
	 * and <code>SeriesInstanceUID</code> to match what was in the supplied {@link AttributeList AttributeList}</p>
	 *
	 * <p>Called when inserting a new record for an instance of the entity.</p>
	 *
	 * <p>Specific to each concrete information model extending {@link DatabaseInformationModel DatabaseInformationModel}.</p>
	 ...
	 * @param	b		the statement being constructed
	 * @param	list		the DICOM attributes of a composite object, containing the attributes describing this instance of the entity
	 * @param	ie		the {@link InformationEntity InformationEntity} for which an insert statement is being constructed
	 * @throws	DicomException	thrown if there are problems extracting the DICOM attributes
	 */
	 ...
	 * <p>The file reference type is left empty since unknown.</p>
	 *
	 * @deprecated use  {@link DatabaseInformationModel#extendInsertStatementStringWithAttributeValuesForSelectedInformationEntity(StringBuffer,AttributeList,InformationEntity,String,String) extendInsertStatementStringWithAttributeValuesForSelectedInformationEntity()} instead
	 *
	 * @param	b		the statement being constructed
	 * @param	list		the DICOM attributes of a composite object, containing the attributes describing this instance of the entity
	 * @param	ie		the {@link InformationEntity InformationEntity} for which an insert statement is being constructed
	 ...
	 * <p>Called when inserting a new record for an instance of the entity.</p>
	 *
	 * @param	ie	the {@link InformationEntity InformationEntity} for which a key is requested
	 ...
	 *
	 * @param	ie		the {@link InformationEntity InformationEntity}
	...
	boolean isAttributeUsedInTable(String tableName,String columnName) {
		if (listsOfAttributesByInformationEntity != null) {
			LinkedList listOfAttributes = (LinkedList)listsOfAttributesByInformationEntity.get(tableName.toUpperCase(Locale.US));
			if (listOfAttributes != null) {
				if (listOfAttributes.contains(columnName.toUpperCase(Locale.US))) {
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} of the record to be updated
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} of the record to be returned
	 * @param	localPrimaryKeyValue	the string value of the unique key which identifies the instance of the entity (not including wildcards)
	 * @return				a {@link TreeMap TreeMap} of {@link String String} values indexed by {@link String String} upper case column names
	 ...
	 * @return				a {@link String String} value, or an empty string if not found
	 * @throws	DicomException		thrown if the query fails
	 */
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} of the records to be returned
	 * @return				an {@link ArrayList ArrayList} of records, each value of which is a
	 *					{@link TreeMap TreeMap} of {@link String String} values indexed by {@link String String} upper case column names
	 * @throws	DicomException		thrown if the query fails
	 */
...
//slf4jlogger.debug("Select all values for all records of "+ie.toString()+" time "+(System.currentTimeMillis()-startTime)+" milliseconds");
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} of the records to be returned
	 * @param	uid			the {@link String String} UID of the records to be returned
	 * @return				an {@link ArrayList ArrayList} of records, each value of which is a
	 *					{@link TreeMap TreeMap} of {@link String String} values indexed by {@link String String} upper case column names
	 * @throws	DicomException		thrown if the query fails
	 */
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} of the records to be returned
	 * @param	keyName		the {@link String String} name of the key to be matched
	 * @param	keyValue	the {@link String String} value of the key to be matched
	 * @return				an {@link ArrayList ArrayList} of records, each value of which is a
	 *					{@link TreeMap TreeMap} of {@link String String} values indexed by {@link String String} upper case column names
	 * @throws	DicomException		thrown if the query fails
	 */
...
//slf4jlogger.debug("Select all values for all records of "+ie.toString()+" time "+(System.currentTimeMillis()-startTime)+" milliseconds");
	...
	private final String[] getArrayOfColumnNamesForSpecifiedInformationEntity(InformationEntity ie,ResultSet r) throws SQLException {
...
//slf4jlogger.debug("Select all values for all records of {} with specified parent time {} milliseconds",ie.toString(),(System.currentTimeMillis()-startTime));
	 ...
	 *
	 * @param	ieWanted		the {@link InformationEntity InformationEntity} of the record level of the attribute to be returned
	 * @param	ieParent		the {@link InformationEntity InformationEntity} of the record level of the parent to be matched
...
//slf4jlogger.debug("Select all values for all records of {} with matching parent time {} milliseconds",ieWanted.toString(),(System.currentTimeMillis()-startTime));
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} that is the parent, such as a patient,  study, etc.
	...
	public static String getTableNameForInformationEntity(InformationEntity ie) {
		return ie.toString().toUpperCase(Locale.US);
	}
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} that is the parent, such as a patient,  study, etc.
	 * @return				the {@link InformationEntity InformationEntity} that is the child
	 */
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity} that is the parent, such as a
	 *					patient,  study, etc.
	 ...
	 * @param	ie			the {@link InformationEntity InformationEntity} that is the parent, such as a
	 *					patient,  study, etc.
	 * @param	list			the {@link AttributeList AttributeList} that are the contents the instance
	 * @return				the {@link InformationEntity InformationEntity} that is the child
	 */
	 ...
	 *
	 * @param	ie			the {@link InformationEntity InformationEntity}, such as a
	 *					patient,  study, etc.
	 ...
	 * <p>For a particular information entity, find the name of the column in the entity's database table containing the local file name of a stored object.</p>
	 *
	 * @deprecated use  {@link DatabaseInformationModel#getLocalFileNameColumnName(InformationEntity) getLocalFileNameColumnName()} instead
	 *
	 * @param	ie	the {@link InformationEntity InformationEntity}, such as a
	 *			instance (e.g. an image)
	 * @return		the upper case string name of the column	
	...
	/**
	 * <p>For a particular information entity, find the name of the column in the entity's database table containing the record insertion time recorded as the value returned by {@link System#currentTimeMillis() System.currentTimeMillis()}.</p>
	 *
	 * @param	ie	the {@link InformationEntity InformationEntity}, such as a
	 *			patient,  study, etc.
	 * @return		the upper case string name of the column	
