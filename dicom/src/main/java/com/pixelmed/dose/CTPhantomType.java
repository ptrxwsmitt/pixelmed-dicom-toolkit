...
public class CTPhantomType implements Comparable {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dose/CTPhantomType.java,v 1.14 2022/01/21 19:51:22 dclunie Exp $";
