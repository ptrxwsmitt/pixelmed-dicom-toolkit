...
public class GenerateRadiationDoseStructuredReport {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/doseocr/GenerateRadiationDoseStructuredReport.java,v 1.27 2022/01/21 19:51:22 dclunie Exp $";
	 ...
	 * one {@link CTDose CTDose} instance; if there are multiple dose screens which is encountered first will be used. Does not currently account for multi-page dose
	 ...
	 * @return				a {@link CTDose CTDose} object that contains the information to extract as an {@link StructuredReport StructuredReport} or  {@link AttributeList AttributeList}
	 */
