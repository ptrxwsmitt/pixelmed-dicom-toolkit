...
public class TestAttributeListReadTerminationStrategy extends TestCase {
	...
	public static Test suite() {
		...
		suite.addTest(new TestAttributeListReadTerminationStrategy("TestAttributeListReadTerminationStrategy_ByteOffset_NoPreambleNoMetaInformationHeader"));
		suite.addTest(new TestAttributeListReadTerminationStrategy("TestAttributeListReadTerminationStrategy_ByteOffset_PreambleButNoMetaInformationHeader"));
	...
	private AttributeList makeAttributeList() throws DicomException {
...
//System.err.println("TestAttributeListReadTerminationStrategy_TagRange(): a "+a);
	...
	private class OurReadTerminationStrategy_ByteOffset_NoPreambleNoMetaInformationHeader implements AttributeList.ReadTerminationStrategy {
		public boolean terminate(AttributeList attributeList, AttributeTag tag, long byteOffset) {
			return byteOffset >= 124;	// this number for this test gets us as far as Manufacturer and no further (NB. we have no meta-header and no preamble)
		}
	}
	
	public void TestAttributeListReadTerminationStrategy_ByteOffset_NoPreambleNoMetaInformationHeader() throws Exception {
		String creatorValue = "Test Creator";
		File testFile = File.createTempFile("TestAttributeListReadTerminationStrategy_ByteOffset_NoPreambleNoMetaInformationHeader",".dcm");
		testFile.deleteOnExit();
		{
			AttributeList list = makeAttributeList();
			list.write(testFile,TransferSyntax.ExplicitVRLittleEndian,false/*useMeta - actually preamble*/,true/*useBufferedStream*/);
		}
		{
			AttributeList list = new AttributeList();
			AttributeList.ReadTerminationStrategy strategy = new OurReadTerminationStrategy_ByteOffset_NoPreambleNoMetaInformationHeader();
			list.read(testFile,strategy);
...
//System.err.println("TestAttributeListReadTerminationStrategy_ByteOffset(): a "+a);
	...
	private class OurReadTerminationStrategy_ByteOffset_PreambleButNoMetaInformationHeader implements AttributeList.ReadTerminationStrategy {
		public boolean terminate(AttributeList attributeList, AttributeTag tag, long byteOffset) {
			return byteOffset >= 256;	// this number for this test gets us as far as Manufacturer and no further (NB. we have no meta-header and no preamble)
		}
	}
	
	public void TestAttributeListReadTerminationStrategy_ByteOffset_PreambleButNoMetaInformationHeader() throws Exception {
		String creatorValue = "Test Creator";
		File testFile = File.createTempFile("TestAttributeListReadTerminationStrategy_ByteOffset_PreambleButNoMetaInformationHeader",".dcm");
		testFile.deleteOnExit();
		{
			AttributeList list = makeAttributeList();
			list.write(testFile,TransferSyntax.ExplicitVRLittleEndian,true/*useMeta - actually preamble*/,true/*useBufferedStream*/);
		}
		{
			AttributeList list = new AttributeList();
			AttributeList.ReadTerminationStrategy strategy = new OurReadTerminationStrategy_ByteOffset_PreambleButNoMetaInformationHeader();
			list.read(testFile,strategy);
			//System.err.println("TestAttributeListReadTerminationStrategy_ByteOffset():\n"+list);
