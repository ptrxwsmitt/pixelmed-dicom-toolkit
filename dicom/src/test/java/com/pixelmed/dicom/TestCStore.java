...
//		if (NetworkUtilities.isPortOnLocalHostResponding(port)) {
//System.err.println("Port for SCP already in use");
//			throw new DicomException("Port for SCP already in use");
//		}
...
//System.err.println("SCP is now RUNNABLE");
		while (!storageSOPClassSCPDispatcher.isReady()) {
			Thread.currentThread().sleep(waitIntervalWhenSleeping);	// wait until SCP is ready, else later send may fail
		}
//System.err.println("SCP is Ready");
		
		new StorageSOPClassSCU("localhost",port,scpAET,scuAET,"testnetworkfile_scevrle.dcm",null/*affectedSOPClass*/,null/*affectedSOPInstance*/,0/*compressionLevel*/);
//System.err.println("Back from sending");
...
//System.err.println("Have lastReceivedDicomFileName");
...
//System.err.println("Association has been released");

		storageSOPClassSCPDispatcher.shutdown();
//System.err.println("SCP has been shutdown");
		while (storageSOPClassSCPDispatcher.isReady()) {
...
//System.err.println("SCP is no longer ready");
	}
...
//System.err.println("SCP will listen on port "+port);
		...
		new StorageSOPClassSCU("localhost",port,scpAET,scuAET,fileset,0/*compressionLevel*/,null/*multipleInstanceTransferStatusHandler*/);
...
//System.err.println("SCP will listen on port "+port);
		...
		StorageSOPClassSCU storageSOPClassSCU = new StorageSOPClassSCU("localhost",port,scpAET,scuAET,fileset,0/*compressionLevel*/,null/*multipleInstanceTransferStatusHandler*/);
