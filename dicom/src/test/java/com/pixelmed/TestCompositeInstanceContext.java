...
public class TestCompositeInstanceContext extends TestCase {
	...
	public static Test suite() {
		...
		suite.addTest(new TestCompositeInstanceContext("TestCompositeInstanceContext_RemoveAllButPatientAndStudyUsingSelectorSelected"));
		suite.addTest(new TestCompositeInstanceContext("TestCompositeInstanceContext_RemoveAllButPatientAndStudyUsingSelectorUnselected"));
	...
	public void TestCompositeInstanceContext_Constructor() throws Exception {
		...
		String clinicalTrialSubjectID = "4652945";
		String clinicalTrialTimePointID = "TP4";
		String clinicalTrialSeriesID = "42";
		...
		{ Attribute a = new LongStringAttribute(TagFromName.ClinicalTrialSubjectID); a.addValue(clinicalTrialSubjectID); list.put(a); }
		{ Attribute a = new LongStringAttribute(TagFromName.ClinicalTrialTimePointID); a.addValue(clinicalTrialTimePointID); list.put(a); }
		{ Attribute a = new LongStringAttribute(TagFromName.ClinicalTrialSeriesID); a.addValue(clinicalTrialSeriesID); list.put(a); }
		...
		assertEquals("Checking ClinicalTrialSubjectID",clinicalTrialSubjectID,Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialSubjectID));
		assertEquals("Checking ClinicalTrialTimePointID",clinicalTrialTimePointID,Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialTimePointID));
		assertEquals("Checking ClinicalTrialSeriesID",clinicalTrialSeriesID,Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialSeriesID));
		...
		assertEquals("Checking SeriesNumber",seriesNumber,Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.SeriesNumber));
		assertEquals("Checking ClinicalTrialSeriesID","",Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialSeriesID));
		...
		cic.removeStudy();
		cicList = cic.getAttributeList();
		assertEquals("Checking StudyID","",Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.StudyID));
		assertEquals("Checking ClinicalTrialTimePointID","",Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialTimePointID));

		cic.removePatient();
		cicList = cic.getAttributeList();
		assertEquals("Checking PatientID","",Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.PatientID));
		assertEquals("Checking ClinicalTrialSubjectID","",Attribute.getSingleStringValueOrEmptyString(cicList,TagFromName.ClinicalTrialSubjectID));
	}
	...
	public void TestCompositeInstanceContext_RemoveAllButPatient() throws Exception {
		...
		assertTrue("Checking ClinicalTrialTimePointID",Attribute.getSingleStringValueOrNull(cicList,TagFromName.ClinicalTrialTimePointID) == null);
		assertTrue("Checking ClinicalTrialSeriesID",Attribute.getSingleStringValueOrNull(cicList,TagFromName.ClinicalTrialSeriesID) == null);
	}
	...
	public void TestCompositeInstanceContext_RemoveAllButPatientAndStudyUsingSelectorSelected() throws Exception {
		...
		CompositeInstanceContext.Selector selector = new CompositeInstanceContext.Selector(true/*allSelected*/);
		selector.patient = false;
		selector.study = false;
		cic.removeAllSelected(selector);
		AttributeList cicList = cic.getAttributeList();
	...
	public void TestCompositeInstanceContext_RemoveAllButPatientAndStudyUsingSelectorUnselected() throws Exception {
		...
		CompositeInstanceContext.Selector selector = new CompositeInstanceContext.Selector(false/*allSelected*/);
